...
module.exports = {
    ...
    async execute(interaction) {
        if (
            ...
            switch (selectedValue) {
                case "destekbug":
                    await interaction.reply({
                        content: `<@${interaction.user.id}> Ticketin açılıyor...`,
                        ephemeral: true,
                    });
                    const destekticketi =
                    ...
                    const militaninticketegonderdigimesaj = new EmbedBuilder()
                        .setColor("#000000")
                        .setTitle(
                            `${interaction.user.username} - ${destekbugmesaj}`
                        )
                ...
                case "icproblemler":
                    ...
                    const militaninembedmessagesi = new EmbedBuilder()
                        .setColor("#000000")
                        .setTitle(
                            `${interaction.user.username} - ${icproblemmesaj}`
                        )
                        .setDescription(minik.ticket.menuayarlari.icmesaj);
                ...
                case "ozelmenu":
                    ...
                    const ozelmenumessagesi = new EmbedBuilder()
                        .setColor("#000000")
                        .setTitle(
                            `${interaction.user.username} - ${ozelmenumesaj}`
                        )
                        .setDescription(minik.ticket.menuayarlari.icmesaj);
                ...
                case "otherproblems":
                    ...
                    const militaninembedmessagesi3 = new EmbedBuilder()
                        .setColor("#000000")
                        .setTitle(
                            `${interaction.user.username} - ${otherproblemmesaj}`
                        )
                        .setDescription(minik.ticket.menuayarlari.icmesaj);
                ...
                case "baskaproblems":
                    ...
                    const changeNameInput = new TextInputBuilder()
                        ...
                        .setPlaceholder(
                            "Sorununu açık ve net bir şekilde belirt."
                        )
                        .setStyle(TextInputStyle.Paragraph);

                    const changeActionRow =
            ...
            interaction.customId === "baskaproblemsModal"
        ) {
            const acikcasorun =
                interaction.fields.getTextInputValue("acikcasorun");
            const ticketId = ticketChannels.get(interaction.user.id);
            const ticketChannel =
                interaction.guild.channels.cache.get(ticketId);
